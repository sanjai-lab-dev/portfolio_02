  ...
  const skills = [
    {
      ...
      color: "hover:drop-shadow-[0_0_15px_rgba(51,153,70,0.5)]",
      master: "90%"
    },
    {
      name: "Express",
      image: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg",
      color: "invert hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]",
      master: "80%"
    },
    {
      name: "GitHub",
    ...
    },
    {
      ...
      color: "hover:drop-shadow-[0_0_15px_rgba(255,108,55,0.5)]",
      master: "70%"
    },
    {
      name: "MongoDB",
      image: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg",
      color: "hover:drop-shadow-[0_0_15px_rgba(71,162,72,0.5)]",
      master: "90%"
    },
    {
      name: "MySQL",
      image: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg",
      color: "hover:drop-shadow-[0_0_15px_rgba(0,117,143,0.5)]",
      master: "100%"
    }
  ];

  return (
    <div className="relative flex flex-wrap gap-6 md:gap-8 items-center justify-center min-h-full w-full bg-[var(--bg-right)] overflow-hidden pt-20 md:pt-28 pb-10 px-4 md:px-8">
